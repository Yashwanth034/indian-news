...
the final WorldNews message format:
    ...
    [2-5 useful explanatory sentences]
...
# The final message carries 2-5 useful explanatory sentences:
# never fewer than two (below that the story is not
# published) and never more than five (extra sentences are
# dropped, never padded).
MIN_EXPLANATORY_SENTENCES = 2
MAX_EXPLANATORY_SENTENCES = 5
